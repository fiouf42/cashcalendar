...
<html>
	...
	<%@ include file="menu.jsp" %>
		...
		<p>Les risques sont à la charge de l’acquéreur à compter du moment où les produits ont quitté les locaux de FouadCorporation. En cas de dommage pendant le transport, la protestation motivée doit être formulée auprès du transporteur dans un délai de trois jours à compter de la livraison.</p>
		...
		<p>Les acheteurs peuvent s’opposer à la divulgation de leurs coordonnées en le signalant à FouadCorporation. De même, les utilisateurs disposent d’un droit d’accès et de rectification des données les concernant, conformément à la loi du 6 janvier 1978.</p>
